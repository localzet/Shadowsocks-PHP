...
{
    /**
     * @var AuthAesProtocol|OriginProtocol
     */
    protected AuthAesProtocol|OriginProtocol $_protocol;
    ...
    public function __construct($key, $iv, $protocol, $param)
    {
        $this->_protocol = match ($protocol) {
            'auth_aes128_md5', 'auth_aes128_sha1' => new AuthAesProtocol($key, $iv, $protocol, $param),
            default => new OriginProtocol(),
        };
    }
